        ...
        <>
            ...
            <div className="relative h-32 w-32">
                <div className='absolute inset-x-0 top-0 h-16 w-screen'>
                    <ul className='bg-gray-900 px-4 py-4'>
...
export default function Navbar() {
    ...
    return (
        <>
            {/* Desktop */}
            <nav className="hidden sm:hidden md:flex bg-gray-900 h-16 flex-row justify-between items-center px-8">
                <span className="text-lg font-bold text-white">Steve Morales</span>
            ...
            {/* Mobile */}
            <nav className="sm:flex md:hidden bg-gray-900 h-16 flex flex-row justify-between items-center px-8">
                <span className="text-lg font-bold text-white">Steve Morales</span>
