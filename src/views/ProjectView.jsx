        ...
        <div className="bg-gray-950 min-h-screen">
            <section className="flex flex-col min-h-screen relative">
                ...
                <div className="items-center">
                    <img alt="background" src={imgSrc ? imgSrc : "https://via.placeholder.com/900x600"} className="z-0 blur-md align-middle object-cover absolute h-[calc(100vh-64px)] w-full opacity-30" />
